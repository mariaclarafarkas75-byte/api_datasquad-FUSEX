# Specificações de um Tema - 2

## Resumo

Como professor, quero indicar quais temas são opcionais, para que eles apareçam apenas se houver tempo no semestre.
...
- Certifique-se que o professor consiga inserir se um tema é opcional ou não.
- Certifique-se que o banco de dados guarde um valor `booleano`.
