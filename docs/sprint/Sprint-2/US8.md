...
Como professor, quero organizar meus temas por disciplina, para não misturar conteúdos diferentes.
...
- Permitir a visualização de temas, reorganizados com base na disciplina a qual pertencem.
- A visualização deve mostrar todos os atributos de um tema.
- A visualização deve ser feita de forma simples, a fim de exigir o mínimo de interações do professor.
